...
void motor_controller(motor motor_data)
{
    ...
    */
    ...
    digitalWrite(motor_1_terminal_1_pin, motor_data.motor_1_terminal_1);
    digitalWrite(motor_1_terminal_2_pin, motor_data.motor_1_terminal_2);
    digitalWrite(motor_2_terminal_1_pin, motor_data.motor_2_terminal_1);
    digitalWrite(motor_2_terminal_2_pin, motor_data.motor_2_terminal_2);
